...
| RFC - 005     | Busca de Usuário por ID Válido         | Um usuário com ID conhecido (12345) existe                | GET /usuarios/id                            | 200 OK, dados do usuário correspondente                 | Passou           |
| RFC - 006     | Busca de Usuário por ID Inválido       | Um ID que não existe (99999)                              | GET /usuarios/id                            | 404 Not Found, mensagem de erro                        | Passou           |
