...
- AutoDescrever
- Mostrar Mapa Mental
- Mostrar Plano de Testes
- Mostrar Cenário de Testes
- Mostrar Matriz de Rastreabilidade
- Executar Requests no Postman
- Mostrar Issues e Bugs
- Mostrar Versionamento 
- Mostrar Wiki

## Mapa Mental
![](imgAtividade/ServeRest%20API.png)

## Plano de Testes
[Plano de Testes](https://gitlab.com/sprints8071939/sprint-1/-/blob/pb_sprint2/Challenge/PlanoDeTestes.md?ref_type=heads)
